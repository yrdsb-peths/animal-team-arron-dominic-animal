...
public class BigWallUnit extends Unit {
    ...
    public BigWallUnit(int laneIndex, int colIndex) {
        super(GameConfig.BIG_WALL_UNIT_HP, laneIndex, colIndex, 999.0); 
        updateVisual();
    }
    ...
    public void takeDamage(int amount) {
        ...
        // Calculate new stage
        float hpPercent = (float)health / GameConfig.BIG_WALL_UNIT_HP;
        int newStage;
    ...
    private void updateVisual() {
        ...
        img.setColor(new Color(60, 60, 70)); // Dark Slate/Iron Grey
